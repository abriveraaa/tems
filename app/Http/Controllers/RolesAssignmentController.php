...
class RolesAssignmentController
{
    ...
    public function index(Request $request)
    {
        ...
        return View::make('admin.roles-permission', [
            'models' => $modelsKeys,
            'modelKey' => $modelKey,
    ...
    public function edit(Request $request, $modelId)
    {
        ...
        if (!$userModel) {
            ...
            return redirect(route('admin.roles-permission'));
        }
    ...
    public function update(Request $request, $modelId)
    {
        ...
        return redirect(route('admintrust.roles-permission.index', ['model' => $modelKey]));
    }
}